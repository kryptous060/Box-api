...
package com.box.gallery.ui.home
...
import com.box.gallery.security.BiometricEncryptionManager
import com.box.gallery.security.PassphraseHolder
import com.box.gallery.security.SecurityUtils
import com.box.gallery.ui.common.ClickableLink
import com.box.gallery.ui.common.tos.AppTosDialog
import com.box.gallery.ui.modelmanager.ModelManagerViewModel
import com.box.gallery.ui.theme.ThemeSettings
import com.box.gallery.ui.theme.labelSmallNarrow
      ...
      Column(
        ...
        Column(
          ...
          Column(modifier = Modifier.fillMaxWidth().semantics(mergeDescendants = true) {}) {
            ...
            val biometricLockEnabled = remember { mutableStateOf(com.box.gallery.security.AppLockManager.isBiometricLockEnabled()) }
            Row(
              ...
              androidx.compose.material3.Switch(
                ...
                onCheckedChange = {
                  com.box.gallery.security.AppLockManager.setBiometricLockEnabled(context, it)
          ...
          Column(modifier = Modifier.fillMaxWidth().semantics(mergeDescendants = true) {}) {
            ...
            val screenshotsEnabled = remember {
              mutableStateOf(com.box.gallery.security.AppLockManager.isScreenshotsEnabled())
            }
            Row(
              modifier = Modifier.fillMaxWidth().padding(top = 4.dp),
              horizontalArrangement = Arrangement.SpaceBetween,
              ...
              androidx.compose.material3.Switch(
                ...
                onCheckedChange = {
                  com.box.gallery.security.AppLockManager.setScreenshotsEnabled(context, it)
          ...
          Column(modifier = Modifier.fillMaxWidth().semantics(mergeDescendants = true) {}) {
            ...
            val offlineEnabled = com.box.gallery.security.OfflineMode.isEnabled.collectAsState()
            Row(
              modifier = Modifier.fillMaxWidth().padding(top = 4.dp),
              horizontalArrangement = Arrangement.SpaceBetween,
              verticalAlignment = Alignment.CenterVertically,
              ...
              androidx.compose.material3.Switch(
                ...
                onCheckedChange = {
                  com.box.gallery.security.OfflineMode.setEnabled(context, it)
                },
              )
            }
          }
                ...
                TextButton(onClick = {
                    ...
                    BiometricEncryptionManager.promptEncrypt(
                        ...
                        onSuccess = { cipher ->
                            ...
                            com.box.gallery.security.AppLockManager.setBiometricLockEnabled(context, false)
                        },
