...
import com.box.gallery.common.processLlmResponse
    ...
    viewModelScope.launch(Dispatchers.Default) {
      ...
      val supportImage =
        model.llmSupportImage &&
          task.id == com.box.gallery.data.BuiltInTaskId.LLM_ASK_IMAGE
      val supportAudio =
        model.llmSupportAudio &&
          task.id == com.box.gallery.data.BuiltInTaskId.LLM_ASK_AUDIO
