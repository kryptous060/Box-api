...
package com.box.gallery.worker
...
import com.box.gallery.data.KEY_MODEL_COMMIT_HASH
import com.box.gallery.data.KEY_MODEL_DOWNLOAD_ACCESS_TOKEN
import com.box.gallery.data.KEY_MODEL_DOWNLOAD_ERROR_MESSAGE
import com.box.gallery.data.KEY_MODEL_DOWNLOAD_FILE_NAME
import com.box.gallery.data.KEY_MODEL_DOWNLOAD_MODEL_DIR
import com.box.gallery.data.KEY_MODEL_DOWNLOAD_RATE
import com.box.gallery.data.KEY_MODEL_DOWNLOAD_RECEIVED_BYTES
import com.box.gallery.data.KEY_MODEL_DOWNLOAD_REMAINING_MS
import com.box.gallery.data.KEY_MODEL_EXTRA_DATA_DOWNLOAD_FILE_NAMES
import com.box.gallery.data.KEY_MODEL_EXTRA_DATA_URLS
import com.box.gallery.data.KEY_MODEL_IS_ZIP
import com.box.gallery.data.KEY_MODEL_NAME
import com.box.gallery.data.KEY_MODEL_START_UNZIPPING
import com.box.gallery.data.KEY_MODEL_TOTAL_BYTES
import com.box.gallery.data.KEY_MODEL_UNZIPPED_DIR
import com.box.gallery.data.KEY_MODEL_URL
...
class DownloadWorker(context: Context, params: WorkerParameters) :
  ...
  override suspend fun doWork(): Result {
    ...
    try {
      com.box.gallery.security.OfflineMode.assertOnlineOrThrow()
    } catch (e: com.box.gallery.security.OfflineMode.OfflineModeException) {
